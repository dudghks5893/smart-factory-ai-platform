...
C5-4B1에서는 train 84장만 사용한 ModelOpt INT8 PTQ로 explicit Q/DQ ONNX 생성을 완료했습니다. C5-4B2에서는 이 exact Q/DQ artifact를 source로 고정해 strongly typed TensorRT INT8 engine build foundation을 준비하며, validation characterization은 아직 실행하지 않았습니다.
